      ...
      <section className="section section--tight" style={{ paddingTop: 24 }}>
        <div className="container">
          <div data-stagger className="audience-grid">
            <AudienceCard title={t.home.audienceLarge} body={t.home.audienceLargeBody} cta={t.home.audienceLargeCta} color="var(--c-blue)" colorHex="#0165dd" to={`/${lc}/services`} />
      ...
      <section className="section section--tight">
        <div className="container about-split">
          <div data-reveal>
            ...
            <button ref={wipeAbout.ref} onClick={() => router.push(`/${lc}/about`)} className="btn-wipe"
      ...
      <section className="section">
        <div className="container">
          ...
          <div data-stagger className="ind-pills-grid">
            <IndustryPill color="#0165dd" label={t.home.pillEnergy} href={`/${lc}/industries#energia`} />
            <IndustryPill color="#11bf74" label={t.home.pillTelco}  href={`/${lc}/industries#telecomunicacoes`} />
            <IndustryPill color="#0a0a0a" label={t.home.pillFmcg}   href={`/${lc}/industries#grande-consumo`} />
            <IndustryPill color="#c8243d" label={t.home.pillAll}    href={`/${lc}/industries`} />
          </div>
        </div>
      </section>
